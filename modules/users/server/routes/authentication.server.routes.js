...
module.exports = function(app) {
  ...
  app.route('/api/auth/signup_validate/username').post(users.signupValidation);
  app.route('/api/auth/signup_validate/email').post(users.signupValidation);
  app.route('/api/auth/signup_validate/password').post(users.signupValidation);
