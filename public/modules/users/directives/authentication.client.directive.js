      ...
      link: function(scope, element, attributes, ngModel) {
        ngModel.$asyncValidators.validateUsername = function(modelValue, viewValue) {
          ...
          if (value) {
            ...
            return $http.post('auth/signup_validate/username', {username: value}).success(function() {
      ...
      link: function(scope, element, attributes, ngModel) {
        ngModel.$asyncValidators.validateEmail = function(modelValue, viewValue) {
          ...
          if (value) {
            ...
            return $http.post('auth/signup_validate/email', {email: value}).success(function() {
      ...
      link: function(scope, element, attributes, ngModel) {
        ngModel.$asyncValidators.validatePassword = function(modelValue, viewValue) {
          ...
          if (value) {
            ...
            return $http.post('auth/signup_validate/password', {password: value}).success(function() {
